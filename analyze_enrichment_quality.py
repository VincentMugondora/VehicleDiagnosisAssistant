...
def main():
    ...
    try:
        ...
        print(f"✅ Found {len(all_codes)} total codes")
    ...
    print("\n⚠️  Limitation: Generic enrichment is boilerplate fallback")
    ...
    if top_codes_generic:
        ...
        print("✅ All top codes already have specific enrichment!")
